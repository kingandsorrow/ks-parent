...
var sendLogin = (code, mobile, validate_token) => fetch('/doLogin', {
	code,
	mobile,
	validate_token
}, 'POST');
 ...
 * 账号密码登录
 */
export const accountLogin = (username, password, captcha_code) => fetch('', {username, password, captcha_code}, 'POST');
